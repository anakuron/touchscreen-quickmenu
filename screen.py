...
#volup
    ...
    if number == 3:
        # c
	subprocess.call(["xbacklight", "-dec", "5"])

    if number == 4:
        # d
	subprocess.call(["xbacklight", "-inc", "5"])
    if number == 5:
        # e 
	pygame.quit()
        subprocess.call("xkill")
...
make_button("vol down", 30, 105, 55, 210, tron_light)
make_button("vol up", 260, 105, 55, 210, tron_light)
# Third Row buttons 3 and 4
make_button("blight dec", 30, 180, 55, 210, tron_light)
make_button("blight inc", 260, 180, 55, 210, tron_light)
# Fourth Row Buttons
make_button("xkill", 30, 255, 55, 210, tron_light)
make_button("QUIT", 260, 255, 55, 210, tron_light)
